...
export default function RewiewItem({ name, rewiew }: RewiewItemProps) {
  return (
    <CarouselItem className="md:basis-1/2 lg:basis-1/3 flex flex-col items-center   h-40 border-2 rounded-2xl border-border   m-4 p-4  shadow-md shadow-primary relative">
