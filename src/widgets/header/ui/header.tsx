            ...
            {isMenuOpen && (
              <>
                <div
                  ...
                  className="w-full flex flex-col justify-center items-center gap-8 min-h-screen absolute top-0 left-0 z-10 bg-background/50 backdrop-blur-sm motion-preset-focus cursor-pointer"
                >
